...
#ifdef MERLIN_ASM_RV32_IO_H
#define MERLIN_ASM_RV32_IO_H
...
/**
 * @brief  RISC-V 32bits asm implementation of ioread8
 *
...
/**
 * @brief  RISC-V 32bits asm implementation of ioread16
 *
 * @param addr source address
 ...
 * @note this function is always inline
 *
 * @warning this may be problematic prior to RISC-V architecture
 */
__attribute__((always_inline))
...
/**
 * @brief  RISC-V 32bits asm implementation of ioread32
 *
 * @param addr source address
 * @return readden word
 *
