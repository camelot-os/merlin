 ...
 * @return DRV_STATUS_OK on success, DRV_ERROR_INVSTATE if not initialised, DRV_ERROR_AGAIN on failure.
 */
 ...
 *
 * @param label DTS label of the target USART peripheral.
 * @param data  Pointer to a single byte to store the received data.
 *
